            ...
            <div className="col-lg-6">
                ...
                <div className="shadow-sm p-3 mb-5 mt-5 bg-white rounded border-0">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="pinterestUrl" className="form-label">Pinterest URL</label>
                            <input
                                type="url"
                                className="form-control"
                                id="pinterestUrl"
                        ...
                        <div className="mb-3">
                            <label htmlFor="vkUrl" className="form-label">VK URL</label>
                            <input
                                type="url"
                                className="form-control"
                                id="vkUrl"
                        ...
                        <div className="mb-3">
                            <label htmlFor="telegramUrl" className="form-label">Telegram URL</label>
                            <input
                                type="url"
                                className="form-control"
                                id="telegramUrl"
